...
?>
		...
		<fieldset><legend>Modification des infos</legend>
			<form class="modifpseudo" method="post" action="modifEnt.php" >
			...
			<form class="modifmdp" method="post" action="modifEnt.php" >
			...
			<form class="modifmail" method="post" action="modifEnt.php" >
			...
			<form method="post" action="modifEnt.php" class="modifier" >
